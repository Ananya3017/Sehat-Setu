    ...
    <PageWrap>
      ...
      <div style={{
        ...
        <div style={{display:"flex",alignItems:"center",gap:16}}>
          <div style={{width:54,height:54,borderRadius:"50%",
            ...
            fontSize:24,fontWeight:800}}>{user.name[0]}</div>
          <div>
            <div style={{fontSize:11,opacity:.7,letterSpacing:"0.1em",textTransform:"uppercase"}}>
              Health Vault · Secure Records
            </div>
            <div style={{fontSize:22,fontWeight:800,
              fontFamily:"'Noto Serif Display',serif"}}>{user.name}</div>
            <div style={{fontFamily:"'JetBrains Mono',monospace",
              fontSize:12,opacity:.8,marginTop:2}}>{user.abha}</div>
          </div>
        </div>
      ...
      <div style={{
        ...
        <div style={{fontSize:24,fontWeight:800,marginBottom:3,
          fontFamily:"'Noto Serif Display',serif"}}>{user.name}</div>
        <div style={{fontFamily:"'JetBrains Mono',monospace",fontSize:14,opacity:.85,
          letterSpacing:"0.1em",marginBottom:16}}>{user.abha}</div>
      ...
      <div style={{display:"flex",gap:8,marginBottom:22}}>
        {["records","upload","consent"].map(t=>(
          <button key={t} onClick={()=>setTab(t)}
            ...
            style={{padding:"8px 18px",borderRadius:22,fontSize:12,fontWeight:700,
      ...
      {tab==="upload"&&(
        <div className="page-enter">
          <Card style={{padding:30,maxWidth:600}}>
            ...
            {uploaded&&(
              <div style={{padding:"10px 14px",background:C.greenLt,
        ...
        <div className="page-enter">
          <Card style={{padding:24}}>
            ...
            {[
              ...
              <div key={c.who} style={{display:"flex",justifyContent:"space-between",
