  ...
  return (
    <div style={{
          ...
          <div style={{padding:"64px 0 64px"}}>
            ...
            <div className="page-enter" style={{
              ...
              <span style={{fontSize:12,fontWeight:600,color:C.text,
                letterSpacing:"0.04em"}}>ABDM Integrated System</span>
            </div>
            ...
            <div className="page-enter s3" style={{display:"flex",gap:14,flexWrap:"wrap"}}>
              ...
              <Btn label="Check Health Score" onClick={()=>setPage("score")}
                variant="ghost" style={{fontSize:14,padding:"12px 24px",
      ...
      <PageWrap>
            ...
            <Card key={f.page} style={{cursor:"pointer",borderLeft:`5px solid ${f.color}`}}
              ...
              <div style={{padding:26}}>
                ...
                <div style={{fontSize:18,fontWeight:800,color:C.text,marginBottom:10,
                  fontFamily:"'Noto Serif Display',serif"}}>{f.title}</div>
        ...
        {/* Demo flow */}
        <Card style={{background:`linear-gradient(135deg,${C.navy},${C.primary})`,
          color:"#fff",padding:"32px 36px"}}>
          <div style={{fontSize:11,fontWeight:700,letterSpacing:"0.12em",
            textTransform:"uppercase",color:C.accent,marginBottom:10}}>Demo Flow for Judges</div>
          <div style={{fontSize:20,fontWeight:800,marginBottom:20,
            fontFamily:"'Noto Serif Display',serif"}}>
            Upload → Vault → Twin → Score → Dashboard
          </div>
          <div style={{display:"flex",gap:0,flexWrap:"wrap",alignItems:"center"}}>
            {[
              ...
              {n:"3",l:"Vault Stores"},
              {n:"4",l:"Twin Analyses"},
              {n:"5",l:"Score Generated"},
              {n:"6",l:"Dashboard View"},
            ].map((s,i)=>(
              <div key={s.n} style={{display:"flex",alignItems:"center"}}>
                <div style={{display:"flex",flexDirection:"column",alignItems:"center",gap:6,
                  ...
                  <div style={{width:36,height:36,borderRadius:"50%",
                    ...
                    display:"flex",alignItems:"center",justifyContent:"center",
                    fontSize:14,fontWeight:800,color:C.accent}}>{s.n}</div>
                  <div style={{fontSize:11,fontWeight:600,color:"rgba(255,255,255,.8)",
                    textAlign:"center",whiteSpace:"nowrap"}}>{s.l}</div>
                </div>
                {i<5&&<div style={{color:"rgba(255,255,255,.3)",fontSize:18,flexShrink:0}}>›</div>}
              </div>
            ))}
          </div>
        </Card>
